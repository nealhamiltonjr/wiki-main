  ...
  webServer: [
    ...
    },
    {
      command:
        ...
        'DB_PATH=data/e2e.db BETTER_AUTH_SECRET=e2e-secret-0123456789abcdef0123456789abcdef BETTER_AUTH_URL=http://localhost:3000 PORT=3000 npx tsx src/server/index.ts',
